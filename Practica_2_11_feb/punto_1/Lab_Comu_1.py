...
class Lab_Comu_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._frecuency_range = qtgui.Range(0, 10000, 100, 1000, 200)
        self._frecuency_win = qtgui.RangeWidget(self._frecuency_range, self.set_frecuency, "Frecuency in Hz", "slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._frecuency_win)
        self._amplitude_range = qtgui.Range(0, 5, 0.1, 1, 200)
        self._amplitude_win = qtgui.RangeWidget(self._amplitude_range, self.set_amplitude, "Amplitude", "eng", float, QtCore.Qt.Horizontal)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, waveform, frecuency, amplitude, offset, 0)
