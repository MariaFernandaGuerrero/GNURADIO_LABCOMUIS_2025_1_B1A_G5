...
class Modulador_de_amplitud(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._Fc_range = qtgui.Range(50e5, 2.2e9, 1e6, 50e6, 200)
        ...
        self.connect((self.Modulador_AM_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.Modulador_AM_0, 0))
